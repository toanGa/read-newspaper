...
public class VnExpressExecute extends ContextPaper {
    int checkFile  = 0;
    String htmlSource;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("myLog","link trong vnexpress " + linkToRead);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(VnExpressExecute.this, HtmlOnline.class);
                //intent.putExtra("link", items.get(position).get_link());
                Bundle myBundle = new Bundle();
                myBundle.putString("link", items.get(position).get_link());
                myBundle.putString("exe_type","vn_express");
    ...
    private class SaveData extends AsyncTask<String,Void,Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(VnExpressExecute.this);
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String filename = "vnexpress0" ;
                String imageFileName = "vnexpress0.jpg";
...
//                }
                while (file.exists()){
                    checkFile ++;
                    filename = "vnexpress" + checkFile;
                    imageFileName = "imgvnexpress" + checkFile + ".jpg";
                    Log.d("myLog","file dang check:" + filename);
                    file = new File(getFilesDir() + "/" + filename);
                }
...
//                helper.SaveItemOnDB(itemOnDB);
                ...
                new SaveImageToInternal(params[1],VnExpressExecute.this,imageFileName);
