...
import com.example.toan.readnewspaper.db_save_item.SaveItemOnDB;
...
public class DantriExecute extends ContextPaper {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.save_bai_viet:
                ...
                //new SaveData().execute(item1.get_link());

                new SaveItemOnDB(DantriExecute.this,item1).execute();
                return true;
        }
        return true;
    ...
    private class SaveData extends AsyncTask<String,Void,Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(DantriExecute.this);
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                ////
                ////
                SoftFile softFile = new SoftFile(DantriExecute.this,filename );
